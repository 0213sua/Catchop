...
class MyAdapter1(val datas: MutableList<String>):
    RecyclerView.Adapter<RecyclerView.ViewHolder>(){
    // 뷰 홀더 준비 위해 자동 호출
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int):
            RecyclerView.ViewHolder = MyViewHolder1(ItemMainBinding.inflate(LayoutInflater.from(parent.context),parent, false))
